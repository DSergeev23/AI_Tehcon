...
const stats = [
  { num: '150+', label: 'проектов по ИИ и 1С' },
  { num: '12 лет', label: 'работы с 1С' },
  { num: '2 года', label: 'на рынке ИИ' },
        ...
        <div className="w-full max-w-[1920px] mx-auto px-5 md:px-8 2xl:px-16 3xl:px-24 pt-16 pb-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
          ...
          >
            <p className="text-sm text-white/50 leading-relaxed mb-6">
              AI TehCon — команда по внедрению искусственного интеллекта в бизнес-процессы с 12-летней экспертизой в программировании на 1С.
            </p>
            <p className="text-sm text-white/35 leading-relaxed">
              Особый фокус — интеграция ИИ и 1С: создаём ИИ-агентов, автоматизируем рутинные операции и связываем нейросети с учётными, торговыми и управленческими системами.
            </p>
          </motion.div>
        </div>
      </div>
