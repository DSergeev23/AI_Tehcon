...
export const pageSEO = {
  ...
  about: {
    title: 'О компании AI TehCon — команда, опыт и подход к работе',
    description: 'Познакомьтесь с AI TehCon: команда, опыт, принципы работы и организация проектов. Узнайте, кто отвечает за внедрение и сопровождение решений.',
    canonical: '/about/',
  ...
  cases: {
    title: 'Кейсы внедрения ИИ и автоматизации | AI TehCon',
    description: 'Реальные кейсы AI TehCon: внедрение ИИ-агентов, интеграции с 1С и автоматизация бизнес-процессов с измеримым результатом.',
    canonical: '/cases/',
    keywords: 'кейсы внедрения ИИ, кейсы автоматизации бизнеса, ИИ для 1С, AI TehCon',
  },
  news: {
